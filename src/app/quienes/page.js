    ...
    <div className="mainContainer">
      ...
      <div className="mainTittle pb-80 pt-64 flex flex-col items-center">
        <button
          ...
          type="button"
          className="inline-flex flex-col items-center justify-center px-5 rounded-tr-full rounded-tl-full hover:bg-gray-50 dark:hover:bg-gray-800 group"
        >
          <svg
            className="w-10 h-10 mb-1 text-gray-50 dark:text-gray-300 group-hover:text-blue-700 dark:group-hover:text-blue-500"
            aria-hidden="true"
