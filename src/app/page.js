  ...
  return (
    <div className="bg-white font-sans ">
      ...
      <div className="bg-white py-6 mx-1">
        <div className="container mx-10 flex items-center justify-between px-4 shadow-md">
      ...
      <div className="bg-white py-40  relative overflow-hidden shadow-sm">
        ...
        <img className="absolute top-32 right-12 w-1/2 transform translate-x-1/8 -translate-y-1/4 " src="/imagenes/fondo1.png"></img>
      </div>
    </div>
  );
}
